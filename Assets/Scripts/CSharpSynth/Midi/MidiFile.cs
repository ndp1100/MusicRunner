...
namespace CSharpSynth.Midi
{
    public class MidiFile
    {
        ...
        public MidiTrack CombinedTrack
        {
            get
            {
                if (this.combinedTrack == null)
                    this.CombineTracks();
                return this.combinedTrack;
            }
        }
        ...
        public void CombineTracks()
        {
            ...
            for (int x = 0; x < ArrayofTrkEvts.Length; x++)
            {
                ...
                while (tmpN != null)
                {
                    ...
                    combinedTrack.TotalTime = combinedTrack.TotalTime + (ulong)tmpN.Value.deltaTime;
                    tmpN = tmpN.Next;
                    cc++;
                }
            }
        ...
        private void loadStream(Stream stream)
        {
            ...
            for (int x = 0; x < trackCount; x++)
            {
                ...
                while (index < tmp.Length)
                {
                    ...
                    //[10/04/2019 10:42:46 PhuongND ] - 
                    MEv.deltaTimeFromStart = timeFromStart + (ulong)MEv.deltaTime;
                    timeFromStart = MEv.deltaTimeFromStart;
                    //End PhuongND ----
